...
export default function MiniPedija(){
    return(
        <div className="minipedija_detail font_face_ps">
            ...
            <div className="discount_title">Pedija15</div>
            <IconContext.Provider value={{color:"#BABABA"}}>
                <div className="close_couponicon">
                    <IoCloseCircleSharp />
                </div>
                ...
                <div className="male_driver">Male driver</div>
                <div className="moreoption_icon">
                    <CgChevronRight />
                </div>
                    </div>
                </div>
